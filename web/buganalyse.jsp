        ...
        <article class="span8 about-box" style="margin-left: 350px;margin-top: -220px">
            ...
            <table style="width: 1000px;">
                                            <tr style="border: solid 1px;font-size: 20px;color:burlywood;font-family: monospace;font-weight: bold;">
                                                ...
                                                <%
                                                String compp=request.getParameter("compe");
                                                HttpSession ses = request.getSession();
                    String                        proo = ses.getAttribute("pro").toString();
                                                    String id, summary, dec, dev, plat, pro, imp, action,bugid,comp,adate = null;
//                                                    String sql = "select * from bug where product='"+fs+"'";
                                                     String sql = "SELECT  * from bug where product = '"+proo+"' and comp='"+compp+"' ";
                                            ...
                                            <tr style="border: solid 1px;font-size: 15px;color: white;font-family: monospace;font-weight: bold;">
                                                <td style="height: 20px;text-align: center"><%=bugid%></td>
                                                <td style="height: 20px;text-align: center"><%=comp%></td>
                                                ...
                                                <td style="text-align: center;"><a style="color: white" href="assign_dev.jsp?<%=id%>,<%=summary%>,<%=plat%>,<%=comp%>">Assign</a></td>
                                            </tr>
                                                <%
                                                    }
                                                %>
