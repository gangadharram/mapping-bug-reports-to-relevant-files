...
<!--                <li><a href="buganalyse.jsp">Analyse Bug Report</a></li>-->
        ...
        <article class="span8 about-box">
            <h5 style="color: white;margin-top: 10px;margin-left: -80px">Data Assigned based on Feature  Selection</h5>

            <br><form action="feature2.jsp" method="post" style="margin-left: 80px">
